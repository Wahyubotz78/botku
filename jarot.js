...
const xtanggal = moment.tz("Asia/Jakarta").format("DD MMMM YYYY");
const xhari = moment.tz("Asia/Jakarta").format("dddd");
const xtime = moment.tz("Asia/Jakarta").format("HH:mm a");
...
module.exports = XeonBotInc = async (XeonBotInc, m, chatUpdate, store, left, welcome) => {
  try {
    var body =
    ...
    const ordermessage =
      m.msg.xtype === "conversation" && m.msg.message.conversation
        ...
        : m.msg.xtype == "extendedTextMessage" && m.msg.message.extendedTextMessage.text.startsWith(prefix)
        ? m.msg.message.extendedTextMessage.text
        : m.msg.xtype == "buttonsResponseMessage" && m.msg.message.buttonsResponseMessage.selectedButtonId.startsWith(prefix)
        ? m.msg.message.buttonsResponseMessage.selectedButtonId
        : m.msg.xtype == "listResponseMessage" && m.msg.message.listResponseMessage.singleSelectReply.selectedRowId.startsWith(prefix)
        ? m.msg.message.listResponseMessage.singleSelectReply.selectedRowId
        : m.msg.xtype == "templateButtonReplyMessage" && m.msg.message.templateButtonReplyMessage.selectedId.startsWith(prefix)
    ...
    const ftroli = {
      ...
      message: { orderMessage: { itemCount: 2022, status: 200, thumbnail: thumb, surface: 200, message: botname, orderTitle: ownername, sellerJid: "0@s.whatsapp.net" } },
    ...
    const fgif = {
      ...
      message: { videoMessage: { title: botname, h: wm, seconds: "359996400", gifPlayback: "true", caption: ownername, jpegThumbnail: thumb } },
    };
    const fgclink = {
      key: { participant: "0@s.whatsapp.net", remoteJid: "0@s.whatsapp.net" },
      message: { groupInviteMessage: { groupJid: "6285808654304-1616169743@g.us", inviteCode: "m", groupName: wm, caption: `${pushname}`, jpegThumbnail: thumb } },
    };
    const fvideo = {
      key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {}) },
      message: { videoMessage: { title: botname, h: wm, seconds: "359996400", caption: `${pushname}`, jpegThumbnail: thumb } },
    };
    ...
    if (db.data.settings[botNumber].autobio) {
      ...
      if (new Date() * 1 - setting.status > 1000) {
        ...
        await XeonBotInc.setStatus(`Nama Bot: ${XeonBotInc.user.name} | Runtime : ${runtime(process.uptime())} | By ${global.ownername}`);
    ...
    if (AntiLinkYoutubeVid)
      if (budy.includes("https://youtu.be/")) {
        ...
        XeonBotInc.sendMessage(
          from,
          { text: `\`\`\`「 YouTube Video Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending youtube video link in this group`, contextInfo: { mentionedJid: [kice] } },
          { quoted: m }
        );
      } else {
      }
    ...
    if (AntiLinkYoutubeChannel)
      if (budy.includes("https://youtube.com/")) {
        ...
        XeonBotInc.sendMessage(
          from,
          { text: `\`\`\`「 YouTube Channel Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending youtube channel link in this group`, contextInfo: { mentionedJid: [kice] } },
          { quoted: m }
        );
      } else {
      }
    ...
    if (AntiLinkAll)
      if (budy.includes("https://")) {
        if (!isBotAdmins) return;
        bvl = `\`\`\`「 Link Detected 」\`\`\`\n\n*====[ RCB-Botz ]====* \n\n*NOTIF*\n==========\n* KAMU ADMIN | ADMIN BEBAS DARI ANTI LINK*\n==========`;
        if (isAdmins) return m.reply(bvl);
        if (m.key.fromMe) return m.reply(bvl);
        if (isCreator) return m.reply(bvl);
        kice = m.sender;
        ...
        XeonBotInc.sendMessage(
          from,
          {
            text: `\`\`\`「 Link Detected 」\`\`\`\n\n*====[ RCB-Botz ]====* \n\n*NOTIF*\n==========\n*@${kice.split("@")[0]} TELAH DI KICK DARI GRUP, KARENA MELANGGAR PERATURAN ANTI LINK *\n==========`,
    ...
    const bhosdike = (teks) => {
      XeonBotInc.sendMessage(
        m.chat,
        {
          ...
          caption: wm,
          contextInfo: {
            externalAdReply: { title: botname, body: ownername, previewType: "PHOTO", showAdAttribution: true, sourceUrl: websitex, thumbnailUrl: "https://i.ibb.co/txS3dDZ/Screenshot-2022-1030-154916.jpg", thumbnail: xeonbugpic },
          },
        },
        { quoted: xezy }
      );
...
${Array.from(room.jawaban, (jawaban, index) => {
  ...
  .join("\n")}
    ${isSurender ? "" : `Perfect Player`}`.trim();
      XeonBotInc.sendText(m.chat, caption, m, { contextInfo: { mentionedJid: parseMention(caption) } })
        .then((mes) => {
    ...
    if (tebaklagu.hasOwnProperty(m.sender.split("@")[0]) && isCmd) {
      ...
      if (budy.toLowerCase() == jawaban) {
        await XeonBotInc.sendButtonText(
          m.chat,
          [{ buttonId: "guess song", buttonText: { displayText: "Guess The Song" }, type: 1 }],
    ...
    if (tebakgambar.hasOwnProperty(m.sender.split("@")[0]) && isCmd) {
      ...
      if (budy.toLowerCase() == jawaban) {
        await XeonBotInc.sendButtonText(
          m.chat,
          [{ buttonId: "guess picture", buttonText: { displayText: "Guess The Picture" }, type: 1 }],
          `🎮 Guess The Picture 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`,
          XeonBotInc.user.name,
          m
        );
    ...
    if (tebakkata.hasOwnProperty(m.sender.split("@")[0]) && isCmd) {
      ...
      if (budy.toLowerCase() == jawaban) {
        await XeonBotInc.sendButtonText(
          m.chat,
          [{ buttonId: "guess word", buttonText: { displayText: "Guess The Word" }, type: 1 }],
          `🎮 Guess The Word 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`,
          XeonBotInc.user.name,
          m
        );
    ...
    if (caklontong.hasOwnProperty(m.sender.split("@")[0]) && isCmd) {
      ...
      if (budy.toLowerCase() == jawaban) {
        await XeonBotInc.sendButtonText(
          m.chat,
          [{ buttonId: "guess blank", buttonText: { displayText: "Guess The Blank" }, type: 1 }],
          `🎮 Guess The Blank 🎮\n\nCorrect Answer 🎉\n*${deskripsi}*\n\nWant To Play Again? Press The Button Below`,
          XeonBotInc.user.name,
          m
        );
    ...
    if (tebakkalimat.hasOwnProperty(m.sender.split("@")[0]) && isCmd) {
      ...
      if (budy.toLowerCase() == jawaban) {
        await XeonBotInc.sendButtonText(
          m.chat,
          [{ buttonId: "guess sentence", buttonText: { displayText: "Guess The Sentence" }, type: 1 }],
          `🎮 Guess The Sentence 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`,
          XeonBotInc.user.name,
          m
        );
    ...
    if (tebaklirik.hasOwnProperty(m.sender.split("@")[0]) && isCmd) {
      ...
      if (budy.toLowerCase() == jawaban) {
        await XeonBotInc.sendButtonText(
          m.chat,
          [{ buttonId: "guess lyrics", buttonText: { displayText: "Guess The Lyrics" }, type: 1 }],
          `🎮 Guess The Lyrics 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`,
          XeonBotInc.user.name,
          m
        );
    ...
    if (tebaktebakan.hasOwnProperty(m.sender.split("@")[0]) && isCmd) {
      ...
      if (budy.toLowerCase() == jawaban) {
        await XeonBotInc.sendButtonText(
          m.chat,
          [{ buttonId: "guess riddle", buttonText: { displayText: "Guess The Riddle" }, type: 1 }],
          `🎮 Guess The Riddle 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`,
          XeonBotInc.user.name,
          m
        );
...
`.trim()
    ...
    switch (command) {
      ...
      case "promo":
        {
          m.reply(`_Haii_ *${pushname}* _${ucapanWaktu}_

_PROMO PANEL DAN ADMIN PANEL AKAN DIADAKAN SETIAP HABIS BERBUKA PUASA DAN SETIAP SAHUR DI BULAN RAMADHAN_
_IKUTI TERUS PROMO NYA DAN AKAN DISELINGI DENGAN BAGI BAGI PANEL DAN COIN SECARA GRATIS,_
_AYO AJAK TEMAN TEMAN KAMU UNTUK MENGIKUTI PROMO INI, SURUH MEREKA JOIN GRUP INI, LINK ADA DI DESK ATAU COPY LINK DI BAWAH INI_
 => NB. BAGI BAGI PANEL SETIAP SAHUR JIKA ADMIN TIDAK TIDUR :V

*LINK GC :* https://chat.whatsapp.com/BzXJ3Vp9B8i8iD7MLvXI2L
*LINK GC :* https://chat.whatsapp.com/BzXJ3Vp9B8i8iD7MLvXI2L`);
        }
        break;
      case "p":
        {
          m.reply(`_Minimal Salam Kak_ *${pushname}* _SALAM ITU PENTING_`);
        }
        break;
      ...
      case "salom":
        {
          m.reply(`_WaalaikumSalam Wr. Wb Kak_ *${pushname}* _${ucapanWaktu}_ `);
        }
      ...
      case "store":
        {
          m.reply(`_Hallo KAk_ *${pushname}* _${ucapanWaktu}_\n
_==== KAMI MENYEDIAKAN ====_\n
=> SERVER PANEL RUN BOT W,A
=> ADMIN PANEL
=> TOPUP GAME SEPERTI
   -> MOBILE LEGENDS
   -> FREE FIRE
   -> PUBG MOBILE
   -> GENSHIN (x)\n\n
_JIKA MINAT LANGSUNG HUBUNGI_ : wa.me/6285808654304
_PEMBAYARAN BISA LEWAT_
 => GOPAY ☑
 => DANA ☑
 => QRIS + (1K BUAT FEE NYA) ☑
...
_RUNTIME_ : ${runtime(process.uptime())}`);
      ...
      case "servbot":
        {
          m.reply(`Hallo *${pushname}* _WELCOME_\n_Server Sekarang sedang_ *Running* Selama :\n${runtime(process.uptime())}`);
        }
        //openai
        break;
      case "san":
      ...
      case "robotmenu":
        {
          m.reply(`======[ OPEN AI MENU ]======
\n*(ChatGPT)*
=> ${prefix}ai
_Tanyakan apa saja kepada AI._\n 
...
_Saya Rcb Botz, Saya dirancang Oleh *${
            global.ownername
          }* , Untuk Mempermudah Pekerjaan Manusia, Saya Bisa Membuat Stiker, Download Musik/Video Youtube | Tiktok | Facebook Dll, Dan saya bisa mencari Sebuah Kata Seperti Di Google, Cocok buat kamu yang ingin mencari sesuatu akan tetapi tidak punya Kouta Internet yang tidak Mumpuni buat srch di Google._\n\nTerima Kasih
...
====[ *BIODATA OWNER* ]====\n
*• NAMA*    : Anas CmlFdhy
*• Owner*   : *${global.botname}*
*• ALAMAT*  : Tulungagung, Jawa Timur
*• UMUR*    : 19
*• GRANDER* : Laki
*• HOBI*    : Mangan, Turu, Ngoding
*• SEKOLAH* : Gaak Sekolah
*• PACAR*   : Nila Nainil Muna
_____________________________
Sosial Media : https://instagram.com/ig.anscmlfdhy\n
====[    RCB-Botz     ]====`);
        }
        break;
      case "menu":
        {
          m.reply(mess.wait);
          m.reply(`
Halo Kk *${pushname}* Ini Menu Dari
_${global.botname}_

Bot Online Selama :    _${runtime(process.uptime())}_
...
┃➺ ${prefix}report [bug]
╚═════════════✪
Bot Onlie : ${runtime(process.uptime())}
TANGGAL : ${xdate}`);
        }
        break;
      case "ttc":
...
*Please* @${m.mentionedJid[0].split`@`[0]} *to type accept/reject*`;
          ...
          let buttonMessage = {
            ...
            contextInfo: {
              externalAdReply: {
                ...
                mediaType: 1,
                mediaUrl: "https://instagram.com/ig.anscmlfdhy",
                sourceUrl: "https://instagram.com/ig.anscmlfdhy",
              },
            },
          };
      ...
      case "cekbot":
        {
          teks = `*「 ${global.botname} Donasi 」*           
          List Donasi:
          ⫹⫺ Via Dana: ${global.dana}
          ⫹⫺ Via Pulsa ${global.pulsa}🍜`;
          let buttons = [{ buttonId: `owner`, buttonText: { displayText: "Owner" }, type: 1 }];
          let buttonMessage = {
            image: { url: `https://telegra.ph/file/150a4519880819a53aeb6.jpg` },
            jpegThumbnail: log0,
            caption: teks,
            footer: `${botname}`,
            buttons: buttons,
            ...
            contextInfo: {
              externalAdReply: {
                ...
                thumbnail: fs.readFileSync("Media/theme/cheemspic.jpg"),
                mediaType: 1,
                mediaUrl: "https://instagram.com/anscmlfdhy",
                sourceUrl: "https://instagram.com/anscmlfdhy",
              },
            },
          };
      ...
      case "chat":
        {
          ...
          if (args[0] === "mute") {
            ...
            XeonBotInc.chatModify({ clear: { message: { id: m.quoted.id, fromMe: true } } }, m.chat, [])
              .then((res) => m.reply(jsonformat(res)))
              .catch((err) => m.reply(jsonformat(err)));
          }
        }
      ...
      case "guess":
        {
          ...
          if (args[0] === "song") {
            ...
            if (caklontong.hasOwnProperty(m.sender.split("@")[0])) {
              ...
              XeonBotInc.sendButtonText(
                m.chat,
                [{ buttonId: "guess saying", buttonText: { displayText: "Guess The Saying" }, type: 1 }],
...
@${me.split("@")[0]} ❤️ @${jodoh.split("@")[0]}`;
          let ments = [me, jodoh];
          let buttons = [{ buttonId: "❤️", buttonText: { displayText: "❤️" }, type: 1 }];
...
Cieeee, What's Going On❤️💖👀`;
      ...
      case "buy":
        {
          m.reply(`Haii ${pushname}\n*Untuk sementara Panel sedang Offline, Maaf`);
        }
        break;
      case "runtime":
        {
          m.reply(`Haii ${pushname}\n*BOTnya ONLINE SELAMA:*\n${runtime(process.uptime())}`);
        }
        break;
      case "req":
      case "request":
      ...
      case "gc":
        {
          ...
          if (args[0] === "t") {
            await XeonBotInc.groupSettingUpdate(m.chat, "announcement")
              .then((res) => m.reply(`*====[ RCB-Botz ]====*\n\n*GRUP TELAH DI TUTUP OLEH ADMIN*`))
              .catch((err) => m.reply(jsonformat(err)));
          } else if (args[0] === "b") {
            await XeonBotInc.groupSettingUpdate(m.chat, "not_announcement")
              .then((res) => m.reply(`*====[ RCB-Botz ]====*\n\n*GRUP TELAH DI BUKA OLEH ADMIN*`))
              .catch((err) => m.reply(jsonformat(err)));
          } else {
            let buttons = [
              { buttonId: "group b", buttonText: { displayText: "Open" }, type: 1 },
              { buttonId: "group t", buttonText: { displayText: "Close" }, type: 1 },
            ];
      ...
      case "nsfw":
        {
          ...
          if (args[0] === "on") {
            ...
            ntnsfw.push(from);
            m.reply("BERHASIL MENGAKTIFKAN nsfw DI GRUP INI");
            ...
            XeonBotInc.sendMessage(
              from,
              { text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nNsfw(not safe for work) feature has been enabled in this group, which means one can access sexual graphics from the bot!`, contextInfo: { mentionedJid: mems } },
              { quoted: m }
            );
          } else if (args[0] === "off") {
            ...
            ntnsfw.splice(off, 1);
            m.reply("BERHASIL MENONAKTIFKAN nsfw DI GRUP INI");
          } else {
            let buttonsntnsfw = [
      ...
      case "antilinkgc":
        {
          ...
          if (!isAdmins) throw mess.admin;
          if (args[0] === "on") {
            if (db.data.chats[m.chat].antilink) return m.reply(`*====[ RCB-Botz ]====* \n\n*NOTIF*\n==========\n*ANTI LINK SUDAH AKTIF SEBELUMNYA*\n==========`);
            db.data.chats[m.chat].antilink = true;
            m.reply(`*====[ RCB-Botz ]====* \n\n*NOTIF*\n==========\n*ANTI LINK AKTIF*\n==========`);
          } else if (args[0] === "off") {
            if (!db.data.chats[m.chat].antilink) return m.reply(`====[ RCB-Botz ]====* \n\n*NOTIF*\n==========\n*ANTI LINK SUDAH TIDAK AKTIF SEBELUMNYA*\n==========*`);
...
View list of Messages With ${prefix}listmsg`);
      ...
      case "start": {
        ...
        if (Object.values(this.anonymous).find((room) => room.check(m.sender))) {
          let buttons = [{ buttonId: "keluar", buttonText: { displayText: "Stop" }, type: 1 }];
      ...
      case "waifu":
        {
          ...
          let buttons = [
            { buttonId: `waifu`, buttonText: { displayText: "Next Image" }, type: 1 },
            { buttonId: `animemenu`, buttonText: { displayText: "⬅️Back" }, type: 1 },
          ];
          let buttonMessage = {
            image: buffer,
      ...
      case "searchgc":
        {
          ...
          let buttons = [
            { buttonId: `gcsearch ${text}`, buttonText: { displayText: "Next" }, type: 1 },
...
`,
      ...
      case "tt":
        ...
        let nih = ` 𝘕𝘪𝘩 𝘒𝘢𝘬 Videonya, Download Musik Klik Tombol Dibawah\nDownload 𝘉𝘺 ${author}`;
        let buttons = [{ buttonId: `tiktokmp3 ${text}`, buttonText: { displayText: "♫ Download Audio" }, type: 1 }];
        let buttonMessage = {
          video: { url: p.nowm },
          caption: nih,
      ...
      case "tiktokaudio":
        {
          ...
          let cap = `𝘕𝘪𝘩 𝘒𝘢𝘬 AudioNya!👇\nDownload By ${global.ownername}`;
      ...
      case "3dbox":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/3d-box-text-effect-online-880.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      ...
      case "lion2":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-lion-logo-mascot-online-938.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      ...
      case "papercut":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-art-paper-cut-text-effect-online-1022.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      ...
      case "transformer":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-a-transformer-text-effect-online-1035.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      ...
      case "neondevil":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-neon-devil-wings-text-effect-online-free-1014.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      ...
      case "3dstone":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/3d-stone-cracked-cool-text-effect-1029.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      ...
      case "3davengers":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-3d-avengers-logo-online-974.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      ...
      case "window":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/write-text-on-foggy-window-online-free-1015.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      ...
      case "blackpinkneon":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-neon-light-blackpink-logo-text-effect-online-1081.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      ...
      case "summertime":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-a-summer-neon-light-text-effect-online-1076.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      ...
      case "whitebear":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/online-black-and-white-bear-mascot-logo-creation-1012.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "thunder2":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-thunder-text-effect-online-881.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
        break;
      ...
      case "neon":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/neon-light-text-effect-online-882.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "matrix2":
      ...
      case "sky":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-a-cloud-text-effect-on-the-sky-online-1004.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "magma":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-a-magma-hot-text-effect-online-1030.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "sand":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/sand-writing-text-effect-online-990.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "pencil":
      ...
      case "graffiti":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-wonderful-graffiti-art-text-effect-1011.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "metallic":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-a-metallic-text-effect-free-online-1041.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "steel":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/steel-text-effect-online-921.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "harrpotter":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-harry-potter-text-effect-online-1025.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "underwater":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/3d-underwater-text-effect-generator-online-1013.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "luxury":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/3d-luxury-gold-text-effect-online-1003.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "glue2":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-3d-glue-text-effect-with-realistic-style-986.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "fabric":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/fabric-text-effect-online-964.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "neonlight":
      ...
      case "lava":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/lava-text-effect-online-914.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "toxic":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/toxic-text-effect-online-901.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "ancient":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/3d-golden-ancient-text-effect-online-free-1060.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "christmas2":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/sparkles-merry-christmas-text-effect-1054.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "sci_fi":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-3d-sci-fi-text-effect-online-1050.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "rainbow":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/3d-rainbow-color-calligraphy-text-effect-1049.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "classic":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/video-game-classic-8-bit-text-effect-1037.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "watercolor2":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-a-free-online-watercolor-text-effect-1017.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "halloweem2":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-a-spooky-halloween-text-effect-online-1046.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "halloweenfire":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/halloween-fire-text-effect-940.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "writing":
      ...
      case "marvel":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-logo-style-marvel-studios-ver-metal-972.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "skeleton2":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-halloween-skeleton-text-effect-online-1047.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "sketch":
      ...
      case "cool":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-a-cool-graffiti-text-on-the-wall-1010.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "collwall":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/create-cool-wall-graffiti-text-effect-online-1009.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "multicolor2":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/online-multicolor-3d-paper-cut-text-effect-1016.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "batman":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/make-a-batman-logo-online-free-1066.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "juice":
        ...
        m.reply(mess.wait);
        maker
          .textpro("https://textpro.me/fruit-juice-text-effect-861.html", [`${q}`])
          .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
          .catch((err) => console.log(err));
        break;
      case "pornhub":
...
*Link* : ${baby1[0].link}`;
      ...
      case "tickle":
        ...
        var wbuttsss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animewall":
        {
          ...
          result = anu[Math.floor(Math.random() * anu.length)];
          let buttons = [{ buttonId: `.wallpaper ${args.join(" ")}`, buttonText: { displayText: "Next Image" }, type: 1 }];
          let buttonMessage = {
            image: { url: result.image[0] },
            caption: `Title : ${result.title}\nCategory : ${result.type}\nDetail : ${result.source}\nMedia Url : ${result.image[2] || result.image[1] || result.image[0]}`,
            footer: `${botname}`,
      ...
      case "animewallpaper2":
        ...
        var walb = [{ buttonId: `.${command} ${q}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
        let wal = {
      ...
      case "trap":
        ...
        let trapbot = [{ buttonId: `trap`, buttonText: { displayText: `Next ⚡` }, type: 1 }];
        let button2Messages = {
          image: { url: waifudd.data.url },
          caption: `Here you go!`,
          buttons: trapbot,
      ...
      case "hneko":
        ...
        let hnekobot = [{ buttonId: `.hneko`, buttonText: { displayText: `Next ⚡` }, type: 1 }];
        let button3Messages = {
          image: { url: waifudd.data.url },
          caption: `Here you go!`,
          buttons: hnekobot,
      ...
      case "nwaifu":
        ...
        let nwaifubot = [{ buttonId: `.hneko`, buttonText: { displayText: `Next ⚡` }, type: 1 }];
        let button4Messages = {
          image: { url: waifudd.data.url },
          caption: `Here you go!`,
          buttons: nwaifubot,
      ...
      case "animenom":
        ...
        let xxhnekobot = [{ buttonId: `.nom`, buttonText: { displayText: `Next ⚡` }, type: 1 }];
      ...
      case "animeneko":
        ...
        var wbutsss = [{ buttonId: `.neko`, buttonText: { displayText: `Next ✨` }, type: 1 }];
        let buttonssMessage = {
      ...
      case "animecry":
        ...
        var wbutt1sss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animekill":
        ...
        var wbuttszzss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animelick":
        ...
        var wbuttszz12ss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animebite":
        ...
        var wbuttszz123ss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animeyeet":
        ...
        var wbuttszz124ss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animebully":
        m.reply(mess.wait);
        waifudd = await axios.get(`https://api.waifu.pics/sfw/lick`);
        var wbuttszz125ss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animebonk":
        ...
        var wbuttszz126ss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animewink":
        ...
        var wbuttszz127ss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animepoke":
        ...
        var wbuttszz128ss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animesmile":
        ...
        var wbuttszz129ss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animewave":
        ...
        var wbuttszz1210ss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animeawoo":
        ...
        var wbuttszz1211ss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animeblush":
        ...
        var wbuttszz1212ss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animesmug":
        ...
        var wbuttszz1213ss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animeglomp":
        ...
        var wbuttszz1214ss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animehappy":
        ...
        var wbuttszz1215ss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animedance":
        ...
        var wbuttszz1216ss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animecringe":
        ...
        var wbuttszz1217ss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animehighfive":
        ...
        var wbuttszz1218ss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animehandhold":
        ...
        var wbuttszz1219ss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animemegumin":
        ...
        var wbuttszz1220ss = [{ buttonId: `.${command}`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "shinobu2":
        ...
        var wbutsss = [{ buttonId: `.shinobu`, buttonText: { displayText: `Next ✨` }, type: 1 }];
      ...
      case "animemegumin":
        ...
        var wbutsss = [{ buttonId: `.megumin`, buttonText: { displayText: `Next ✨` }, type: 1 }];
        let buttonzMessage = {
          image: { url: ud.data.url },
          caption: `Here you go!`,
          footer: `${global.botname}`,
      ...
      case "autostiker":
        ...
        if (!isBotAdmins) return m.reply(mess.botAdmin);
        if (!isAdmins && !isCreator) return m.reply(mess.admin);
        if (args.length < 1) return m.reply("*====[ RCB-Botz ]====* \n\n*NOTIF*\n==========\n*PERINTAH* :\n*Autostiker [ON]*\n*Autostiker [OFF]*\n==========");
        if (args[0] === "on") {
          if (isAutoSticker) return m.reply(`*====[ RCB-Botz ]====* \n\n*NOTIF*\n==========\n*AUTO STIKER SUDAH AKTIF SEBELUMNYA*\n==========`);
          autosticker.push(from);
          fs.writeFileSync("./database/autosticker.json", JSON.stringify(autosticker));
          m.reply("*====[ RCB-Botz ]====* \n\n*NOTIF*\n==========\n*BERHASIL MENGAKTIFKAN AUTO STIKER / AUTO STIKER AKTIF*\n==========");
        } else if (args[0] === "off") {
          if (isAutoSticker) return m.reply(`*====[ RCB-Botz ]====* \n\n*NOTIF*\n==========\n*AUTO STIKER SUDAH TIDAK AKTIF SEBELUMNYA*\n==========`);
          let anu = autosticker.indexOf(from);
          autosticker.splice(anu, 1);
          fs.writeFileSync("./database/autosticker.json", JSON.stringify(autosticker));
          m.reply("*====[ RCB-Botz ]====* \n\n*NOTIF*\n==========\n*BERHASIL MENONAKTIFKAN AUTO STIKER / AUTO STIKER OFF*\n==========");
        }
        break;
      case "autostickerpc":
      case "autostikerpc":
      ...
      case "antilinkytvid":
        {
          ...
          if (args[0] === "on") {
            ...
            XeonBotInc.sendMessage(
              from,
              { text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nIf you're not an admin, don't send the youtube video link in this group or u will be kicked immediately!`, contextInfo: { mentionedJid: mems } },
              { quoted: m }
            );
          } else if (args[0] === "off") {
      ...
      case "antilinkytch":
        {
          ...
          if (args[0] === "on") {
            ...
            XeonBotInc.sendMessage(
              from,
              { text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nIf you're not an admin, don't send the youtube channel link in this group or u will be kicked immediately!`, contextInfo: { mentionedJid: mems } },
              { quoted: m }
            );
          } else if (args[0] === "off") {
      ...
      case "antilinktwit":
        {
          ...
          if (args[0] === "on") {
            ...
            await XeonBotInc.sendButtonText(m.chat, buttonsntilink, `*====[ RCB-Botz ]====* \n\n*NOTIF*\n==========\n*PERINTAH :\nAutostiker [ON]\nAutostiker [OFF]*\n==========`, `${global.botname}`, m);
          }
        }
        break;
      case "antilinkall":
        {
          ...
          if (!isAdmins && !isCreator) return m.reply(mess.admin);
          if (args[0] === "on") {
            if (AntiLinkAll) return m.reply("*====[ RCB-Botz ]====* \n\n*NOTIF*\n==========\n*BERHASIL MENGAKTIFKAN ANTI LINK SEBELUMNYA / ANTI LINK ON*\n==========");
            ntilinkall.push(from);
            m.reply("*====[ RCB-Botz ]====* \n\n*NOTIF*\n==========\n*BERHASIL MENGAKTIFKAN ANTI LINK / ANTI LINK ON*\n==========");
            var groupe = await XeonBotInc.groupMetadata(from);
            var members = groupe["participants"];
            var mems = [];
            members.map(async (adm) => {
            ...
            XeonBotInc.sendMessage(from, { text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nJika Anda bukan admin, jangan kirim Link apa pun di grup ini atau Anda akan langsung diKick!`, contextInfo: { mentionedJid: mems } }, { quoted: m });
          } else if (args[0] === "off") {
            if (!AntiLinkAll) return m.reply("*====[ RCB-Botz ]====* \n\n*NOTIF*\n==========\n*BERHASIL MENONAKTIFKAN ANTI LINK SEBELUMNYA / ANTI LINK OFF*\n==========");
            let off = ntilinkall.indexOf(from);
            ntilinkall.splice(off, 1);
            m.reply("*====[ RCB-Botz ]====* \n\n*NOTIF*\n==========\n*BERHASIL MENONAKTIFKAN ANTI LINK / ANTI LINK OFF*\n==========");
          } else {
            let buttonsntilink = [
              { buttonId: `${command} on`, buttonText: { displayText: "On" }, type: 1 },
              { buttonId: `${command} off`, buttonText: { displayText: "Off" }, type: 1 },
      ...
      case "thx kepada":
        {
          throw `From ${botname}
┏═┅〔 *Terima Kasih Kepada* 〕┅═
┃⫹⫺ Indo-mypanel.my.id ( My Panel )
┃⫹⫺ Rcb-Botz
┃⫹⫺ Whatsapp Mods By _DodiStudio_
┃⫹⫺ _Support System_ : ${global.ownername2}
┃⫹⫺ _IT System_ : ${global.itsystemname}
┃⫹⫺ _IT System_ : ${global.itsystemnomer}
┃⫹⫺ _Coding By_ : ${global.ownername}
┃⫹⫺ Moduls By _@adiwajshing_
┃⫹⫺ IndBotz
┃⫹⫺ Penel Support By Pterodactyl
┃⫹⫺ You
┃⫹⫺ All Creator BOT
┗═┅〔 *By AnsOffcls* 〕┅═
*Waktu* : ${xtime} WIB
      ...
      case "menuerroryaaa":
        {
          const sections = [
            {
              title: "RCB-BOTZ By Ansoffcls × Nlanlmna",
              rows: [
                {
                  title: "𝘔𝘦𝘯𝘶 𝘖𝘵𝘩𝘦𝘳",
      ...
      case "allmenu":
        {
          ...
          const buttons = [
            { buttonId: "List Menu", buttonText: { displayText: "command" }, type: 1 },
